...
% Sexton2015 review
Since then, several studies have investigated the functional implications of TADs. A somewhat tautologic aspect of TADs is that functional contacts, such as those between enhancers and promoters, tend to happen within a domain rather than between domains.\cite{Sexton2015} This follows directly from the definition of TADs as self-interacting domains. Hormonal treatment of human breast cancer cells reported coordinated expression responses within TADs, suggesting they function as domains of transcriptional co-regulation called "regulons".\cite{LeDily2014} However the size of TADs means they often span multiple genes, commonly with unrelated functions, so it seems unlikely they can function as regulons in the general case.\cite{Pombo2015}
