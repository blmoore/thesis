...
\subsection{Looping}\label{intro:loops}

It has long been thought that enhancer elements are brought into proximity with the promoter(s) they're regulating; under this model, these contacts form a "loop" structure between two potentially distal loci.\cite{Kadauke2009a, Sexton2009} A model region, the $\beta$-globin locus and its locus control region (LCR) located 40-80 kb away,\cite{Dekker2013} has been studied since the early 1980s,\cite{Banerji1981, Engel2000, Blackwood1998} and is an interesting example of how enhancer elements can effect broader nuclear architecture. Current knowledge suggests the $\beta$-globin forms loops with the multiple distal \emph{cis}-enhancer elements which make up the LCR, together forming an active chromatin hub (ACH).\cite{VandeCorput2012a} Within such a hub, regulatory signals could be efficiently integrated to dictate the overall activity of the target locus.\cite{Pombo2015} It is now thought that the majority of active promoters are engaged with multiple, often cell type specific, regulatory looping events.\cite{Sanyal2012, Jin2013}

A notable component of many long-range looping events is the CCCTC-binding transcription factor (CTCF),\cite{Ong2014, Phillips2009} already mentioned as a component of TAD boundaries (Section \ref{intro:tads}) and as a looping factor in the SBS model (Section \ref{intro:sbs}).

% bring back around to Rao2014 via CTCF

% Reviews: Ong2014, Philips2009

%A more liberal definition of looping has been used to explain nuclear architecture at multiple scales: from DNA looping around histone octamers, to transcription factories bringing together multiple loci and finally to these distant contacts between enhancers and promoters, in the scale of megabases.\cite{Heermann2011}
