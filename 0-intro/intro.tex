...
% ploidy
A more esoteric consideration with C-data is that organisms under study are typically diploid, while maps of chromosome organisation are commonly collapsed onto a haploid pseudo-genome. Experiments can delineate haplotype information using deep sequencing, though commonly this is only attempted for specific experiment designs, such as comparing active and inactive X-chromosomes. CITEXX
