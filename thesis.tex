...
{\flushleft Parts of Section \ref{sec:metatads} are used in a manuscript which is under review at the time of writing:}
...
changes in cellular differentiation. \emph{Under review}
\end{quote}
