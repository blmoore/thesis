...
hESC, relative to the other two cell types. 
...
Results of this significance testing, along with selected boundary profiles, are presented in Figure \ref{fig:boundarysummary}. Overall compartment and TAD boundaries are associated with overlapping spectra of chromatin
...
Many other features show significant, though often modest, enrichments in a particular cell type. However, overall the complexity of TAD boundaries (measured as the number of strongly enriched features) is notably higher in H1 hESC than in the other two, more differentiated, cell types (Fig. \ref{fig:boundarysummary}), involving large increases in the binding of sequence specific factors such as SP1 and JUND.
...
features in our dataset (Fig. \ref{fig:ctcfyy1}). Unexpectedly, we found that
...
\section{\emph{De novo} boundary prediction}\label{sec:boundarypred}
