...
My part in this collaboration was to analyse 3C-seq (also known as 4C) data recorded by our collaboratoes for the SHH--ZRS region in mouse. Additionally, the 4C procedure was adapted for specific in-house sequencing instruments (IonTorrent\textsuperscript{TM} as opposed to Illumina\textsuperscript{TM}) and as such required diagnostics to confirm the experimental data was accurate. 
