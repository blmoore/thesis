...
Thus far efforts towards the computational modelling of chromatin have been focused either at learning functional chromatin states from histone modifications and transcription factors (e.g. \citenum{Ernst2012, Ram2011,
  Dunham2012, Hoffman2013, Rajagopal2013, Song2014, Luo2013}), spanning small regions on the order of hundreds of basepairs, or alternatively towards the inference of the overall three-dimensional chromatin fibre trajectory based on conformation data (e.g. \citenum{Bau2011a, Hu2013a, Varoquaux2014a, Lesne2014, Trieu2014, Peng2013, Ay2014b, Caudai2015}). In this work we attempt an intermediate approach, in which we use locus-level chromatin information to model characteristics derived from nuclear architecture, such as chromosomal comparments and topological domains.
